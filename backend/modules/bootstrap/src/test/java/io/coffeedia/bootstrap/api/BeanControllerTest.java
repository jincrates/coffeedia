            ...
            webTestClient.post()
                ...
                .value(response -> {
                    ...
                    assertAll(
                        ...
                        () -> assertThat(data.origin().country()).isEqualTo(command.origin().country()),
                        () -> assertThat(data.origin().region()).isEqualTo(command.origin().region()),
...
//                    assertThat(response).isNotNull();
//                    assertThat(response.success()).isFalse();
//                    assertThat(response.message()).contains("원산지 국가는 필수입니다");
//                    assertThat(response.data()).isNull();
//                });
//        }
