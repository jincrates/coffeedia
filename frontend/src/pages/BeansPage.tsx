  ...
  return (
      <>
        <PageLayout
            ...
            onAddNew={canPerformAction('create') ? handleCreateBean : undefined}
        ...
        >
          ...
          <BeanList
              ...
              loading={isLoading}
              onEdit={canPerformAction('edit') ? handleEditBean : undefined}
              onDelete={canPerformAction('delete') ? handleDeleteBean : undefined}
