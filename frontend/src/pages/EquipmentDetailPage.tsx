...
import {formatDate, getActiveStatusKorean, getEquipmentTypeKorean} from '@/utils/format';
...
const EquipmentDetailPage: React.FC = () => {
  ...
  const handleEdit = () => {
    ...
    }, '장비 수정은 로그인이 필요합니다. (본인이 등록한 장비만 수정 가능)');
  };
  ...
  const handleDelete = () => {
    ...
    }, '장비 삭제는 로그인이 필요합니다. (본인이 등록한 장비만 삭제 가능)');
  };
  ...
  return (
      <EntityDetailLayout
          ...
          onBack={handleBack}
          onEdit={canPerformAction('edit') ? handleEdit : undefined}
          onDelete={canPerformAction('delete') ? handleDelete : undefined}
          onShare={handleShare}
