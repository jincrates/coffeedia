...
import {CreateEquipmentCommand, EquipmentResponse} from '@/types/api';
...
const EquipmentsPage: React.FC = () => {
  ...
  const {requireAuth, canPerformAction} = useAuth();
  ...
  return (
      <>
        <PageLayout
            ...
            onAddNew={canPerformAction('create') ? handleAddEquipment : undefined}
            onSearch={handleSearch}
            addButtonLabel="장비 추가"
        >
          <EquipmentList
              onAddEquipment={canPerformAction('create') ? handleAddEquipment : undefined}
              onEditEquipment={canPerformAction('edit') ? handleEditEquipment : undefined}
              onViewEquipment={handleViewEquipment}
              onDeleteEquipment={canPerformAction('delete') ? handleDeleteEquipment : undefined}
